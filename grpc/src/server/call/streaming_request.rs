...
pub struct StreamingRequest<T, P> {
    stream: PushStream<T, P>,
    initial_metadata: Metadata,
}

impl<T, P> StreamingRequest<T, P> {
    /// Creates a new StreamingRequest.
    pub fn new(stream: PushStream<T, P>, initial_metadata: Metadata) -> Self {
        Self {
            stream,
            initial_metadata,
        }
    ...
    pub fn into_parts(self) -> (Metadata, PushStream<T, P>) {
